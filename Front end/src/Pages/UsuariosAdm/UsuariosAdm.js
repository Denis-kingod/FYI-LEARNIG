...
export default class UsuariosAdm extends Component {
  ...
  buscarTipoUsuario = () => {
    axios("https://fyilearningsolutions.azurewebsites.net/api/TipoUsuariosControllers", {
      headers: {
  ...
  buscarUsuario = () => {
    axios("https://fyilearningsolutions.azurewebsites.net/api/UsuariosControllers")
      .then((resposta) => {
        if (resposta.status === 200) {
